...
function processAdGroups(adGroupIterator, campaignTypeName, campaignName, fromDate, toDate) {
    ...
    while (adGroupIterator.hasNext()) {
        ...
        if (totalConversions > 20) {
            ...
            Logger.log("Average Cost Per Conversion for " + adGroup.getName() + ": " + averageCostPerConversion);
            Logger.log("Average Clicks Per Conversion for " + adGroup.getName() + ": " + averageClicksPerConversion);
